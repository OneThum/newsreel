...
|-----------|--------|-------|---------|-----------|-------|
| 1.1 SimHash Deduplication | ✅ | - | 2025-11-12 | 2025-11-12 | Core functions implemented, integrated into RSS ingestion |
| 1.2 Time-window Filtering | ✅ | - | 2025-11-12 | 2025-11-12 | 72-hour window implemented in clustering queries |
| 1.3 Adaptive Thresholds | ✅ | - | 2025-11-12 | 2025-11-12 | Adaptive thresholds implemented (breaking news stricter, older stories more lenient) |
| 1.4 Enable All RSS Feeds | ✅ | - | 2025-11-12 | 2025-11-12 | RSS_USE_ALL_FEEDS flag already implemented in config |
| 1.5 iOS ETag Support | ✅ | - | 2025-11-12 | 2025-11-12 | ETag generation and 304 responses implemented in API |
| 1.6 Basic Entity Linking | ✅ | - | 2025-11-12 | 2025-11-12 | Enhanced entity extraction with string matching linking |
...
| Component | Status | Owner | Started | Completed | Notes |
|-----------|--------|-------|---------|-----------|-------|
| 2.1 SentenceTransformers Deploy | ✅ | - | 2025-11-12 | 2025-11-12 | Created ACI service, FastAPI app, Dockerfile, and client |
| 2.2 FAISS Index | ✅ | - | 2025-11-12 | 2025-11-12 | Implemented FAISS vector index with multiple index types |
| 2.3 Hybrid Search | ✅ | - | 2025-11-12 | 2025-11-12 | Implemented FAISS + BM25 hybrid candidate generation |
| 2.4 Embedding Pipeline | ✅ | - | 2025-11-12 | 2025-11-12 | Created end-to-end embedding generation and indexing pipeline |
| 2.5 A/B Testing | ✅ | - | 2025-11-12 | 2025-11-12 | Implemented A/B testing framework for gradual rollout |
| 2.6 Cutover | ✅ | - | 2025-11-12 | 2025-11-12 | Integrated A/B testing into clustering pipeline with embedding fallback |
